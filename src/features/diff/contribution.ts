...
const inDiff = 'gitsideDiffFocus'

export const diffContribution: Contribution = {
  commands: [
    { command: 'git.stageSelectedRanges', title: { vs: 'command.stageSelectedRanges' }, category: { text: 'Git' }, enablement: 'gitsideDiffCanStage' },
    { command: 'git.unstageSelectedRanges', title: { vs: 'command.unstageSelectedRanges' }, category: { text: 'Git' }, enablement: 'gitsideDiffCanUnstage' },
    { command: 'git.revertSelectedRanges', title: { vs: 'command.revertSelectedRanges' }, category: { text: 'Git' }, enablement: 'gitsideDiffCanStage' },
  ...
  keybindings: [
    ...
    { command: 'gitlens.toggleFileBlame', key: 'ctrl+shift+g b', mac: 'cmd+alt+g b', when: 'gitside.window == detail' },
  ],
}
