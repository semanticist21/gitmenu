...
export const historyContribution: Contribution = {
  commands: [
    ...
    // Not a GitLens command, so its label is one of gitmenu's own strings
    { command: 'gitmenu.views.openFileWithDefaultApp', title: { app: 'file.openWithDefaultApp' }, category, icon: codicon('link-external') },
  ...
  menus: {
    ...
    'view/item/context': [
      ...
      ...rowMenu([
        ...
        ['gitmenu.views.openFileWithDefaultApp', '2_gitlens_quickopen_file@3', file],
    ...
    commandPalette: [
      ...
      { command: 'gitmenu.views.openFileWithDefaultApp', when: 'false' },
